...
module.exports = {
    ...
    async execute(sock, msg, args, extra) {
        try {
            ...
            const repoUrl = 'https://github.com/Dexsam07/Dex-mini-bot';
            const apiUrl = 'https://api.github.com/repos/Dexsam07/Dex-mini-bot;
            ...
            try {
                ...
                fallbackMessage += `🔗 *Repository:* Dex-mini-bot\n`;
